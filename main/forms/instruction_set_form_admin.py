...
class InstructionSetFormAdmin(forms.ModelForm):
    ...
    action_page_field = forms.IntegerField(label='Required Action: Move', initial=4)
    action_page_interaction = forms.IntegerField(label='Required Action: Move', initial=5)
