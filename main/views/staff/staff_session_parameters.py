...
class StaffSessionParametersView(SingleObjectMixin, View):
    ...
    def get(self, request, *args, **kwargs):
        ...
        try:
            parameter_set_period_form.fields["help_doc"].queryset = session.parameter_set.parameter_set_players.first().instruction_set.help_docs_subject.all()
        except:
            pass
        ...
        return render(request=request,
                      ...
                      context={"channel_key" : uuid.uuid4(),
                               ...
                               "parameter_set_period_form_ids" : parameter_set_period_form_ids,
